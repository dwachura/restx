...
annotation class GenerateJavaProxy

@AutoService(Processor::class)
@SupportedSourceVersion(SourceVersion.RELEASE_8)
class GenerateJavaProxyProcessor : AbstractProcessor() {
    private val supportedAnnotation = GenerateJavaProxy::class.java
...
//        println(toList)
    ...
    private fun process(function: ExecutableElement) {
        ...
        function.getAnnotation(supportedAnnotation)
