...
/**
 * Base interface for generators of [Any] response payloads.
 *
...
sealed interface ErrorPayloadGenerator<in T : Any, out R : ErrorResponsePayload> {
    /**
     * Method that generates payload for given [Any]
     *
...
/**
 * Generator creating payloads for [Any]s caused by single errors.
 */
...
/**
 * Interface for generators creating payloads for [Any]s caused by multiple errors
