...
import io.dwsoft.restx.core.dsl.CauseResolvers
import io.dwsoft.restx.core.dsl.CodeResolvers
import io.dwsoft.restx.core.dsl.MessageResolvers
...
//}
//
//typealias CauseResolverFactoryBlock<T> = FactoryBlock<CauseResolvers<T>, CauseResolver<T>>
//typealias CodeResolverFactoryBlock<T> = FactoryBlock<CodeResolvers<T>, CodeResolver<T>>
//typealias MessageResolverFactoryBlock<T> = FactoryBlock<MessageResolvers<T>, MessageResolver<T>>
//
///**
